  ...
  return (
    <ArticleLayout isMobile={isMobile} breadcrumb="Climbing Shoe Guide">
      ...
      <Collapsible title="Edging - standing on tiny holds" defaultOpen={true}>
        <Prose>
          Edging is about transferring your weight through a small contact point. The score uses a geometric mean of <strong>rigidity</strong> and <strong>shape</strong> - you need both for a top score. Rigidity blends structural stiffness (midsole, rand tension, closure) with perceived stiffness from the shoe's feel. Shape rewards moderate-to-aggressive downturn and strong asymmetry. Hard rubber and lace closure each add smaller bonuses. The top edgers in our database all combine stiff construction with aggressive, strongly asymmetric profiles. A flat shoe can have great stiffness but still score low because it lacks the shape component; conversely, a soft aggressive shoe has shape but not rigidity. For a real-world example of how far the rigidity dial can be pushed, see our <Link to="/insights/scarpa-blackbird" style={{ color: T.accent, textDecoration: "none", fontWeight: 600 }}>Scarpa Blackbird review</Link> - the first carbon-midsole climbing shoe, tested on vertical sandstone micro-edges.
        </Prose>
      </Collapsible>
