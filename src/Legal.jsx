...
function Impressum() {
  return (
    <>
      ...
      <p style={S.p}>
        Diese Website enth\u00e4lt Affiliate-Links zu Partnersh\u00e4ndlern. Wenn Sie \u00fcber diese Links
        ein Produkt kaufen, erhalten wir m\u00f6glicherweise eine Provision. Der Preis f\u00fcr Sie
        \u00e4ndert sich dadurch nicht. Wir empfehlen nur Produkte, von denen wir \u00fcberzeugt sind.
      </p>
      ...
      <p style={S.p}>
        ...
        Herstellern und H\u00e4ndlern und werden mit deren Genehmigung verwendet.
      </p>
    </>
  );
}
...
function PrivacyPolicy() {
  return (
    <>
      ...
      <p style={S.p}>
        Wenn Sie auf einen Affiliate-Link klicken, werden Sie auf die Website des
        jeweiligen H\u00e4ndlers weitergeleitet. Dort gelten die Datenschutzbestimmungen
        des H\u00e4ndlers. Der Affiliate-Partner (AWIN) setzt ggf. ein Cookie zur
        Zuordnung der Transaktion. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.
      </p>
