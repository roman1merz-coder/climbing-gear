...
const FILTER_GROUPS = [
  {
    ...
    filters: [
      ...
      { key: "portability_label", label: "Portability", type: "single", options: ["low", "moderate", "high", "very_high"] },
    ],
  },
  {
    ...
    <div style={{
      ...
      <div onClick={onClick} style={{ padding: "10px" }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: "6px" }}>
          <span style={{ fontSize: "14px", fontWeight: 700, color: "#2c3227", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", minWidth: 0, lineHeight: 1.2 }}>
            {d.model}
          </span>
          {hasDiscount && (
  ...
  return (
    ...
    >
      ...
      <div onClick={onClick} style={{ padding: "16px" }}>
        ...
        {/* Model */}
        <div style={{
          fontSize: "16px", fontWeight: 700, color: "#2c3227",
        ...
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginBottom: "10px" }}>
          <span style={{ fontSize: "11px", color: "#645b4f", display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ fontFamily: "'DM Mono',monospace", fontWeight: 500, fontSize: "12px", color: "#2c3227" }}>{d.length_open_cm}×{d.width_open_cm}</span> cm
          </span>
          <span style={{ fontSize: "11px", color: "#645b4f", display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ fontFamily: "'DM Mono',monospace", fontWeight: 500, fontSize: "12px", color: "#2c3227" }}>{d.thickness_cm}</span> cm thick
          </span>
          <span style={{ fontSize: "11px", color: "#645b4f", display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ fontFamily: "'DM Mono',monospace", fontWeight: 500, fontSize: "12px", color: "#2c3227" }}>{d.weight_kg}</span> kg
          </span>
          <span style={{ fontSize: "11px", color: "#645b4f", display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ fontFamily: "'DM Mono',monospace", fontWeight: 500, fontSize: "12px", color: "#2c3227" }}>{area}</span> m²
          </span>
        </div>
        ...
        {(() => {
          const allTags = [
            ...
            ...(d.portability_label === "very_high" ? [{ label: "Highly portable", variant: "carry" }] : []),
...
export default function CrashpadApp({ crashpads = [], src = "local", priceData = {} }) {
  ...
  useStructuredData(buildItemListSchema(crashpads, "Crashpads", "crashpad"));
  ...
  return (
    <div style={{ background: "#f5f0e8", minHeight: "100vh", color: "#2c3227" }}>
      {/* Sub-header */}
      <header style={{
            ...
            <div style={{ display: "flex", gap: "6px", alignItems: "center", padding: "8px 12px 0" }}>
              ...
              {view === "cards" && (
                ...
                >
                  ...
                  {(CRASHPAD_SORT_OPTIONS.find(o => o.key === sortKey)?.label || "Sort").split(":")[0].replace("Biggest ", "").replace("Newest ", "New")}
                </button>
              )}
              ...
              <div key={g.id} style={{ borderBottom: "1px solid #d5cdbf" }}>
                <button
                  ...
                  style={{
                    ...
                    background: "transparent", border: "none", color: "#2c3227",
                    cursor: "pointer", fontFamily: "'DM Sans',sans-serif",
                  }}
                >
