...
# Read both instruction images
img1_path = os.path.expanduser("~/Library/Containers/ru.keepcoder.Telegram/Data/tmp/IMAGE 2026-03-04 22:30:58.jpg")
img2_path = os.path.expanduser("~/Library/Containers/ru.keepcoder.Telegram/Data/tmp/IMAGE 2026-03-04 22:30:55.jpg")
...
print(f"Sole image: {len(sole_b64)} chars")
print(f"Side image: {len(side_b64)} chars")
...
<div class="instruction-screen">
  ...
  <p class="instruction-text">
    <strong>Hold your phone flat</strong> and lift your foot above the camera.
...
<div class="instruction-screen" id="side-instruction" style="display:none;">
  ...
  <p class="instruction-text">
    <strong>Place your phone on the ground</strong> leaning against a wall.
    Stand your foot next to it so the camera captures the full side profile.
  </p>
...
print(f"Mockup written: {len(html)} chars")
